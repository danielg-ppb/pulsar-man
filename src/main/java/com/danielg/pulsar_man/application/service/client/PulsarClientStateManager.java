...
@Service
public class PulsarClientStateManager implements GetClientStateUseCase {
    ...
    public PulsarClientStateManager(ClientFactory pulsarClientManagerState, ConsumerFactory consumerFactory) {
    ...
    public String getClientState() throws NoSuchFieldException, IllegalAccessException {
        if (this.pulsarClientManagerState.getPulsarClientProvider() != null && this.pulsarClientManagerState.getPulsarClientProvider().getPulsarClient() != null) {
            ...
            ClientConfigurationData configData =
                    (ClientConfigurationData) confField
                            .get(this.pulsarClientManagerState.getPulsarClientProvider().getPulsarClient());
