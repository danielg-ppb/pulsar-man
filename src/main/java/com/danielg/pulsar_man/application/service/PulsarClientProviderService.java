...
@Service
public class PulsarClientProviderService implements InitializeClientProviderUseCase {
    private static final Logger logger = LoggerFactory.getLogger(PulsarClientProviderService.class);

    private final PulsarClientManager pulsarClientManagerState;

    public PulsarClientProviderService(PulsarClientManager pulsarClientManagerState) {
